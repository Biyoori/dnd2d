...
class Weapon(Item):
    def __init__(self, name: str, description: str, weight: float, value: int, weapon_type: str, damage: str, damage_type: str, properties: List[str], finesse: bool = False, range: int = 5) -> None:
